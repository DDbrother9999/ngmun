...
export default function EventInfoContent() {
  return (
    <main className="min-h-screen bg-gray-50 flex flex-col items-center justify-center">
      ...
      <div className="w-full h-[60vh] relative overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-30 text-center px-4">
          ...
          <p className="text-white text-base md:text-lg animate-fade-in">
            Everything you need to know about {CONFERENCE.name}
          </p>
        </div>
      </div>
      ...
      <div className="relative z-40 pt-12 pb-8 px-4 md:px-0 max-w-3xl">
        ...
        <div className="bg-white shadow-lg rounded-3xl p-8 mb-8">
          {FEATURES.SHOW_SECRETARIAT_LETTER && (
            <AnimateOnScroll>
          ...
          <AnimateOnScroll>
            <div className="mb-12">
              ...
              <div className="space-y-3 text-gray-600">
                ...
                <p>{CONFERENCE.shortDate} — Conference Day</p>
              </div>
            </div>
          </AnimateOnScroll>
          ...
          <AnimateOnScroll>
            <div className="mb-12">
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p>
                  Please bring your payment with you on the day of the
                  conference. Note that we are no longer accepting mailed
                  checks. We appreciate your understanding.
                </p>
              </div>
            </div>
          </AnimateOnScroll>
          ...
          <div className="text-center">
            {FEATURES.REGISTRATION_OPEN ? (
              ...
              <p className="text-gray-600 text-sm md:text-base max-w-xl mx-auto">
                Information regarding registration, committees, and background
                guides will be released soon! Please email{" "}
                <Link
